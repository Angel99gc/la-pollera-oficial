...
const MenuSection = () => {
  ...
  const [activeCategory, setActiveCategory] = useState('platosFuertes');
  const [selectedItem, setSelectedItem] = useState(null);

  const categories = [
    { key: 'platosFuertes', label: t.menu.mains },
    { key: 'bocas', label: t.menu.appetizers },
    { key: 'bebidas', label: t.menu.drinks },
    { key: 'postres', label: t.menu.desserts }
  ];
